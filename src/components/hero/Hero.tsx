  ...
  return (
    ...
    <div
      className={cn(
        ...
        "flex flex-row gap-20 items-center justify-around",
      ...
      <div className="w-full flex flex-col justify-between">
        <div className="flex flex-col items-start text-left h-full justify-center w-full">
          ...
          <h1
            className="font-bold leading-[0.9] font-stretch-75% mb-4 w-full text-nowrap text-[30px]"
          >
            Hi, I'm
            <span
        ...
        <div className="flex flex-col gap-10 portrait:gap-[5.6vw]">
          <div className="w-full">
            <div>
              <p className="leading-[1.3]  text-[18px] portrait:text-[min(4.2vw,20px)]">
          ...
          <div>
              <span className="font-bold tracking-wide font-stretch-75% text-[20px]">
